...
export default class VideoPriorityBasedPolicyConfig {
   ...
   */
  constructor(
    private networkIssueResponseDelayFactor: number = 0,
    private networkIssueRecoveryDelayFactor: number = 0
  ) {
  ...
  getNetworkIssueResponseDelayFactor(): number {
    return this.networkIssueResponseDelayFactor;
  }

  getNetworkIssueRecoveryDelayFactor(): number {
    return this.networkIssueRecoveryDelayFactor;
  }
}
